          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item has-treeview menu-open">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="{{ url('opensignal_area_monthly_3g') }}" class="nav-link active">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Opensignal Area (3G)</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <div class="form-group">
                  ...
                  <select class="form-control" id="area">
                      <option value="jabodetabek-jabar">JABOTABEK & JABAR</option>
